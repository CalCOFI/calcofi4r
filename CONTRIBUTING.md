# Contributing to calcofi4r

This outlines how to propose a change to `calcofi4r`. For more detailed
...
# convert inline ROxygen2 documentation from R/*.R to man/*.Rd
devtools::document()

# build website Reference and function documentation into docs/
pkgdown::build_reference()

# OR build entire website into docs/
pkgdown::build_site()
```
...
GitHub repository from the package (e.g. with `usethis::use_git()` +
`usethis::use_github()`), and file an issue with a link to the
repository.

## Rd translation

If you encounter problems with Rd tags, please use
[`rd2html()`](https://pkgdown.r-lib.org/reference/rd2html.html) to
create a reprexes:
...
Code of Conduct](https://calcofi.io/calcofi4r/CODE_OF_CONDUCT.md). By
