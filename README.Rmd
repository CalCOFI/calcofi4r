...
- [**CalCOFI Schema**](https://calcofi.io/db-schema/) — per-release ERD, tables, columns (units + descriptions), datasets, and measurement-type registry. The same `metadata.json` sidecar that powers `cc_describe_table()` and `cc_db_catalog()`.
